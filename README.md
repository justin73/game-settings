...
**Extra**
Here is a simple design mock I also created to illustrate the future extension of this service. [Figma Link](https://www.figma.com/proto/rDuICs8YwqfDdjcEsBRWx9/game-settings?node-id=2%3A13&viewport=492%2C364%2C0.07758382707834244&scaling=min-zoom)
...
3. _limited implementation_
   Since this is a quick assignment, due to time constraint, I didn't start the project based on the vision, more on the actual requirements. so there are some UI elments that are currently not implemented or could be improved, such as the editor, json schema utils(to support more complex use cases).
...
**\_\_styled \_\_**: contains all the related styled component for a given component
